        ...
        <nav className="navbar-custom">
            ...
            <div className="navbar-right d-none d-lg-flex">
                <div className="social-icons">
                    <a href="tel:+79998887766" className="icon-circle"><FaPhone/></a>
                    <a href="https://t.me/username" className="icon-circle"><FaTelegramPlane/></a>
                    <a href="https://wa.me/79998887766" className="icon-circle"><FaWhatsapp/></a>
                </div>
            </div>
